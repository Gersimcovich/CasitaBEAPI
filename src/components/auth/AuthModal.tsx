...
const translations = {
  ...
  fr: {
    ...
    joinCasita: 'Rejoignez Casita pour suivre vos réservations et gagner des points.',
    codeExpires: 'Le code expire dans 10 minutes',
    checkSpam: 'Vous ne le trouvez pas ? Vérifiez votre dossier spam.',
    accountNotFound: 'Aucun compte trouvé avec cet email. Créons-en un !',
  },
  de: {
    signIn: 'Anmelden',
    ...
    enterCode: 'Geben Sie den 6-stelligen Code ein, der an gesendet wurde',
    ...
    joinCasita: 'Werden Sie Casita-Mitglied, um Ihre Reservierungen zu verfolgen und Punkte zu sammeln.',
    codeExpires: 'Code läuft in 10 Minuten ab',
    checkSpam: 'Nicht gefunden? Überprüfen Sie Ihren Spam-Ordner.',
    accountNotFound: 'Kein Konto mit dieser E-Mail gefunden. Erstellen wir eins!',
  },
  it: {
    signIn: 'Accedi',
    ...
    joinCasita: 'Unisciti a Casita per monitorare le tue prenotazioni e guadagnare punti.',
    codeExpires: 'Il codice scade tra 10 minuti',
    checkSpam: 'Non lo trovi? Controlla la cartella spam.',
    accountNotFound: 'Nessun account trovato con questa email. Creiamone uno!',
  },
  pl: {
    signIn: 'Zaloguj się',
    ...
    joinCasita: 'Dołącz do Casita, aby śledzić rezerwacje i zdobywać punkty.',
    codeExpires: 'Kod wygasa za 10 minut',
    checkSpam: 'Nie możesz go znaleźć? Sprawdź folder spam.',
    accountNotFound: 'Nie znaleziono konta z tym emailem. Stwórzmy je!',
  },
  ar: {
    signIn: 'تسجيل الدخول',
    ...
    joinCasita: 'انضم إلى كاسيتا لتتبع حجوزاتك وكسب النقاط.',
    codeExpires: 'ينتهي صلاحية الرمز خلال 10 دقائق',
    checkSpam: 'لا تجده؟ تحقق من مجلد البريد غير المرغوب فيه.',
    accountNotFound: 'لم يتم العثور على حساب بهذا البريد. دعنا ننشئ واحداً!',
  },
  he: {
    signIn: 'התחברות',
    ...
    joinCasita: 'הצטרף ל-Casita כדי לעקוב אחר ההזמנות שלך ולצבור נקודות.',
    codeExpires: 'הקוד פג תוקף בעוד 10 דקות',
    checkSpam: 'לא מוצא? בדוק את תיקיית הספאם.',
    accountNotFound: 'לא נמצא חשבון עם אימייל זה. בוא ניצור אחד!',
  },
  zh: {
    signIn: '登录',
    createAccount: '创建账户',
    ...
    joinCasita: '加入Casita，追踪您的预订并赚取积分。',
    codeExpires: '验证码将在10分钟后过期',
    checkSpam: '找不到？请检查垃圾邮件文件夹。',
    accountNotFound: '未找到此邮箱的账户。让我们创建一个！',
  },
  ru: {
    signIn: 'Войти',
    ...
    joinCasita: 'Присоединяйтесь к Casita, чтобы отслеживать бронирования и зарабатывать баллы.',
    codeExpires: 'Код действителен 10 минут',
    checkSpam: 'Не нашли? Проверьте папку спам.',
    accountNotFound: 'Аккаунт с этим email не найден. Давайте создадим!',
  },
};
