...
import { Menu, X, ShoppingCart, User, Trash2, LogOut, Award, Settings, Tag, HelpCircle, Building2, ChevronDown, CalendarCheck, Shield, ExternalLink } from 'lucide-react';
        ...
        <div className="flex items-center h-16 lg:h-20">
          ...
          <nav className="hidden lg:flex items-center justify-center flex-1">
            <div className="flex items-center space-x-1">
              ...
              {/* Book in Confidence - Airbnb Reviews */}
              <a
                href="https://www.airbnb.com/users/show/7936498#reviews"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2 px-4 py-2 bg-[var(--casita-orange)]/10 text-[var(--casita-orange)] hover:bg-[var(--casita-orange)]/20 rounded-lg transition-colors font-semibold"
              >
            ...
            <nav className="py-4 px-2">
              ...
              <div className="px-2 mb-4">
                <a
                  ...
                  rel="noopener noreferrer"
                  onClick={() => setIsMobileMenuOpen(false)}
                  className="flex items-center gap-3 p-4 bg-[var(--casita-orange)]/10 rounded-xl"
                >
                  <div className="flex items-center justify-center w-10 h-10 bg-[var(--casita-orange)]/20 rounded-full">
                    <Shield className="w-5 h-5 text-[var(--casita-orange)]" />
                  </div>
                  <div className="flex-1">
                    <p className="font-semibold text-[var(--casita-gray-900)]">Book in Confidence</p>
                    <p className="text-xs text-[var(--casita-gray-600)]">60,000+ Airbnb reviews - Verified Superhost</p>
                  </div>
                  <ExternalLink className="w-4 h-4 text-[var(--casita-orange)]" />
                </a>
              </div>
