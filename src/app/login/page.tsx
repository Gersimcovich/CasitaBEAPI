        ...
        <div className="absolute inset-0 flex flex-col justify-center p-12">
          ...
          <div className="max-w-md">
            ...
            <p className="text-xl text-white/80">
              Continue your journey to discover the world&apos;s finest boutique hotels.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-white">
        <div className="w-full max-w-md">
          ...
          <p className="text-[var(--casita-gray-600)] mb-8">
            ...
            <Link href="/signup" className="text-[var(--casita-orange)] hover:underline font-medium">
              Sign up
            </Link>
          </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center cursor-pointer">
                <input
                  type="checkbox"
                  className="w-4 h-4 rounded border-[var(--casita-gray-300)] text-[var(--casita-orange)] focus:ring-[var(--casita-orange)]"
                />
                <span className="ml-2 text-sm text-[var(--casita-gray-600)]">Remember me</span>
              </label>
              <Link
          ...
          <div className="flex items-center my-8">
            ...
            <span className="px-4 text-sm text-[var(--casita-gray-500)]">or continue with</span>
            <div className="flex-1 h-px bg-[var(--casita-gray-200)]" />
          </div>
